...
function refreshEntries()
{
	...
	.done(function(data, textStatus, jqXHR)
	{
		...
		for (let item of data)
		{
			...
			tr    += "    <a class=\"btn_action btn_disabled btn_force\"      onclick=\"if($(this).hasClass('btn_disabled'))return false; doPush("+i+", false);return false;\" alt=\"git push\"         title=\"git push\"                           href=\"#\"><i class=\"fas fa-angle-double-up\"  ></i></a>";
			tr    += "    <a class=\"btn_action btn_disabled\"                onclick=\"if($(this).hasClass('btn_disabled'))return false; doPush("+i+", true); return false;\" alt=\"git push --force\" title=\"git push --force\"                   href=\"#\"><i class=\"fas fa-angle-double-up\"  ></i></a>";
